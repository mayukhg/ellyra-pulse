...
**Draft README** — proposed replacement/extension for the root `README.md`. Review and promote
once approved; the current root `README.md` is Lovable's build brief for the prototype UI and is
left untouched here.
